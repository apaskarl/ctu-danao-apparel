                    ...
                    <div class="settings-container-right">
                        <div class="container">
                            <div class="action-container top">
                                ...
                                <div class="action">
                                    <button class="add" id="addAdmin">Add size</button>
                                </div>
                            </div>
                                ...
                                <div id="table">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM product_size LIMIT 18446744073709551615 OFFSET 1";
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                echo "
                                                    <tr>
                                                        ...
                                                        <td>{$row['size']}</td>
                                                        <td>
                                                            <a href='delete-size.php?size_id={$row['size_id']}'><ion-icon name='trash-outline'></ion-icon></a>
                                                        </td>
                                                    </tr>";
                                            }
                                            ?>
