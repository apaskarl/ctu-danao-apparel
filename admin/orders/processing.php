            ...
            <div class="container">
                ...
                <div class="action">
                    <?php
                            ...
                            <a href="processing.php" class="active">Processing <span>(<?php echo $count_processing; ?>)</span></a>
                    ...
                    <div id="table">
                        <table class="table" id="order-table">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT 
                                                op.order_id, op.order_date,
                                                CONCAT(u.firstname, ' ', u.lastname) AS full_name,
                                                SUM(op.quantity) AS total_quantity,
                                                SUM(op.subtotal) AS total_cost,
                                                u.user_id
                                            FROM 
                                                order_processing op
                                            JOIN 
                                                user u ON op.user_id = u.user_id";

                                if (!empty($search_order_id) && $search_order_id !== 'all') {
                                    $sql .= " WHERE op.order_id = ?";
                                }

                                $sql .= " GROUP BY op.order_id, full_name
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class='toReceive' data-order-id='{$row['order_id']}'>Ready</button>
                                        </td>
                                    </tr>";
                                }
                                ?>
