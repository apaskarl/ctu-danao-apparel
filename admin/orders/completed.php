            ...
            <div class="container">
                ...
                <div class="action">
                    <?php
                            ...
                            <a href="completed.php" class="active">Completed <span>(<?php echo $count_completed; ?>)</span></a>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sql = "SELECT 
                                                oc.order_id, oc.order_date, oc.delivery_date,
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    $orderReceivedDate = strtotime($row['delivery_date']);
                                    $orderReceivedDateFormatted = date('F j, Y', $orderReceivedDate);
                                    $orderReceivedDateTime = date('g:i a', $orderReceivedDate);
                                ...
                                <tr>
                                    ...
                                    <td>{$orderReceivedDateFormatted} - {$orderReceivedDateTime}</td>
                                </tr>";
                                }
                                ?>
                        </tbody>
