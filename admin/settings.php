        ...
        <div class="add-container">
            ...
            <form action="" method="post">
                ...
                <div class="input-box">
                    ...
                    <img src="../assets/images/icons/show.png" id="eyeicon">
                </div>
                <div class="btn-container">
                    <button type="submit" id="confirm">Add admin</button>
                ...
                <div class="settings-container">
                    <div class="settings-container-left">
                        ...
                        <div class="settings-link">
                            ...
                            <a href="settings/sizes.php">Size</a>
                        </div>
                        <div class="settings-link">
                            <ion-icon name="color-fill-outline"></ion-icon>
                            <a href="settings/colors.php">Color</a>
                        </div>
                    </div>
                    ...
                    <div class="settings-container-right">
                        <div class="container">
                            <div class="action-container top">
                                ...
                                <div class="action">
                                    <button class="add" id="addAdmin">Add admin</button>
                                </div>
                            </div>
                                            ...
                                            <?php
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href='delete-admin.php?admin_id={$row['admin_id']}' class='delete-prod'><ion-icon name='trash-outline'></ion-icon></a>
                                                        </td>
                                                    </tr>";
                                                }
                                            ?>
