            ...
            <div class="container">
                ...
                <div class="action">
                    <?php
                            ...
                            <a href="orders.php" class="active">Pending <span>(<?php echo $count_pending; ?>)</span></a>
                            <a href="orders/processing.php">Processing <span>(<?php echo $count_processing; ?>)</span></a>
                            <a href="orders/receive.php">Ready <span>(<?php echo $count_ready; ?>)</span></a>
                            <a href="orders/completed.php">Completed <span>(<?php echo $count_completed; ?>)</span></a>
                            <a href="orders/cancel.php">Cancelled <span>(<?php echo $count_cancelled; ?>)</span></a>
                        </div>
                    </div>
                </div>
