...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($orderId) && is_numeric($orderId)) {
        ...
        $sqlTransfer = "
            INSERT INTO order_receive (order_id, user_id, product_img, product_id, size_id, color_id, quantity, price, subtotal, order_date)
        ...
        if ($stmt) {
            ...
            if ($stmt->execute()) {
                ...
                $sqlDelete = "DELETE FROM order_processing WHERE order_id = ?";
