        ...
        <main>
            <div class="container">
                <div class="action-container top">
                    ...
                    <div class="action">
                        <a href="products/add.php" class="add">Add New Product</a>
                    </div>
                </div>
                        ...
                        <table id="product-table" class="table">
                            ...
                            <tbody>
                                ...
                                <tr class='selectable-row'>
                                    ...
                                    <td>
                                        <a href='products/edit.php?product_id={$row['product_id']}'><ion-icon name='create-outline'></ion-icon></a>
                                        <a href='products/delete.php?product_id={$row['product_id']}' class='delete-prod'><ion-icon name='trash-outline'></ion-icon></a>
                                    </td>
                                </tr>
                                ";
                                }
                ...
                <!-- <div class="action-container bottom">
                    ...
                    <div class="action">
                        <a href="#" id="deleteProduct" class="delete-prod disable">Delete</a>
                    </div>
                </div> -->
            </div>
        </main>
