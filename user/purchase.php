...
<body>
    ...
    <div class="user-container purchase-page">
    <div class="profile-nav">
        ...
        <div class="profile-details">
            <div class="purchase-nav">
                <button onclick="showContent(this, 'to-pay')" class="active">To Pay <span></span></button>
                <button onclick="showContent(this, 'to-process')">Processing <span></span></button>
                <button onclick="showContent(this, 'to-receive')">To Receive <span></span></button>
                <button onclick="showContent(this, 'completed')">Completed</button>
                <button onclick="showContent(this, 'cancelled')">Cancelled</button>
            </div>
    
            <div id="orderContainer" class="content"></div>
            <div id="to-pay-content" class="content"></div>
            <div id="to-process-content" class="content hidden"></div>
            <div id="to-receive-content" class="content hidden"></div>
            <div id="completed-content" class="content hidden"></div>
            <div id="cancelled-content" class="content hidden"></div>
        </div>
    </div>

    <div class="user-purchase-mobile"></div>

    <script>
        function showContent(button, tab) {
            var buttons = document.querySelectorAll('.purchase-nav button');
            ...
            var selectedContentDiv = document.getElementById(tab + '-content');
